...
export interface ApiDeliveryPricingDeliveryPricing
  extends Struct.CollectionTypeSchema {
  collectionName: 'delivery_pricings';
  info: {
    description: '';
    displayName: 'Delivery Pricing';
    pluralName: 'delivery-pricings';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::delivery-pricing.delivery-pricing'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPickDropPickDrop extends Struct.CollectionTypeSchema {
  collectionName: 'pick_drops';
  info: {
    description: '';
    displayName: 'pickDrop';
    pluralName: 'pick-drops';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    has_variations: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    ratings: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
